...
import { doRequestGetUser, doResponseAddUser, doResponseGetUser, getAll } from '../../redux/action/actionReducer';
...
const Users = (props) => {
  ...
  let { userx,message,status,refresh} = useSelector(state => state.userReducers)

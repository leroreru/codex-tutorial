...
const DeleteUser = (props) => {
  ...
  const handleRegistration = async (data) => {
    // console.log(data)
    dispatch(delUser(data),props.closeModal())
    // const result = await apiMethod.deleteUser(data);
                  ...
                  <div className="mt-2">
                    <form onSubmit={handleSubmit(handleRegistration)}>
                      <div className="max-w-xl bg-white py-6 px-3 m-auto w-full mt-6">
                        ...
                        <p className="-mt-2 pb-2 text-center text-md font-medium leading-6 text-gray-900">~ {props.userById.username} ~</p>

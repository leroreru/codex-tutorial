                    ...
                    <div className="container">
                        <div className="flex">
                            ...
                            <div className="w-full">
                                ...
                                <h2 className="text-sm font-light lg:text-base">PT Code Development Indonesia</h2>
                                ...
                                <div className="grid grid-cols-2 max-w-sm pt-2 lg:pt-4">
                                    ...
                                    <div className=" flex  items-center">
                                        ...
                                        <h3 className="text-xs  font-light pl-2 md:text-sm lg:text-md">5-10 tahun pengalaman</h3>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 max-w-sm pt-2 lg:pt-4">
                                    <div className=" flex items-center">
                                        ...
                                        <h3 className="text-xs  font-light pl-2 md:text-sm lg:text-md">Jakarta</h3>
                                    </div>
                                    <div className=" flex items-center">
                                        <ClockIcon height="20" width="20" />
                                        <h3 className="text-xs  font-light pl-2 md:text-sm lg:text-md">Dibuat 1 hari lalu</h3>
                                    </div>
                                </div>

...
router.get('/user',authController.CheckToken,userController.GetUser)
router.patch('/user/:id',userController.UpdateUsers)
router.delete('/user/:id',userController.DeleteUser)
router.get('/userbyview',userController.getUserByView)
...
router.get('/product/image',productController.GetImage)
...
router.patch('/orderdetail/:id',orderDetailController.UpdateOrderDetail)
router.delete('/orderdetail/:id',orderDetailController.DeleteOrderDetail)


router.post('/loginpage',authController.authLogin)
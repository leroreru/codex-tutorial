...
import { doRequestDeleteProductCat } from "../redux/action/actionReducer";

const DeleteProductCat = (props: any) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const handleRegistration = async (data: any) => {
    dispatch(doRequestDeleteProductCat(data));
                    ...
                    <form onSubmit={handleSubmit(handleRegistration)}>
                      <div className="max-w-xl bg-white py-6 px-3 m-auto w-full mt-6">
                        <div className="grid grid-cols-1 gap-4 max-w-xl m-auto">
                          ...
                          <input
                            type="hidden"
                            defaultValue={props.prodCatById.id}

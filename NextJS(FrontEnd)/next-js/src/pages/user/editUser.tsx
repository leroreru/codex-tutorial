...
import { doRequestUpdateUser } from "../redux/action/actionReducer";
const EditUser = (props: any) => {
  ...
  const handleRegistration = async (data: any) => {
    dispatch(doRequestUpdateUser(data));
    props.closeModal();
  };
                        ...
                        <div className="grid grid-cols-1 gap-4 max-w-xl m-auto">
                          ...
                          <div className="col-span-1">
                            <input
                              ...
                              defaultValue={props.userById.firstname}
                              {...register(
                                "firstname",
                          ...
                          <div className="col-span-1">
                            <input
                              ...
                              defaultValue={props.userById.lastname}
                              {...register(
                                "lastname",
